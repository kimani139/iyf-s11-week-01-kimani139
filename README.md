...
## Introduction
This guide covers tools that every student should know about. Each section is written by a different team member. Follow the collaboration workflow described in the assignment: create a branch for your section, write your content, and open a PR.
...
2. Clone the repository:
   ...
   git clone https://github.com/kimani139/iyf-s11-week-01-kimani139.git
   cd iyf-s11-week-01-kimani139
...
- Repository link: https://github.com/kimani139/iyf-s11-week-01-kimani139
...
If you want, I can now create branches and commit the three section drafts on separate branches so each teammate has a ready branch to open a PR from. Reply: "Create branches with drafts" to have them created.
